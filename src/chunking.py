...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # No separators left or empty string separator: force character-level split
        ...
        # Separator not present in text: try the next one
        if sep not in current_text:
            return self._split(current_text, next_seps)

        # Split by separator and greedily merge pieces back up to chunk_size
        ...
        # Recursively handle any merged chunk that is still oversized
        result: list[str] = []
        for chunk in merged:
